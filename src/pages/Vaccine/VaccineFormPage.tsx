...
import { getVaccine, createVaccine, updateVaccine } from '../../api/vaccineService'
  ...
  return (
    <div className="max-w-xl mx-auto px-6 py-12">
      ...
      {fetching ? (
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-petIndigoLight rounded-3xl px-8 py-9 space-y-6 shadow-sm">
          ...
          <div>
            <label className="block text-xs font-semibold text-petMuted uppercase tracking-wider mb-1.5">
              Próxima dosis <span className="normal-case font-normal">(opcional)</span>
            </label>
            <input
              type="date"
              name="next_dose"
